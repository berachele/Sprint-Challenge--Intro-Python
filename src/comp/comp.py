...
c = [name.name for name in humans if name.name[0] == 'C' or name.name[0] == 'G']
print(c)
...
f = [f'{name.name}, {name.age}' for name in humans if name.age > 26 and name.age < 33]
print(f)
...
g = [f'{name.name.upper()}, {name.age+5}' for name in humans]
print(g)
